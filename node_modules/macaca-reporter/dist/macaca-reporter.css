...
@font-face {
  font-family: 'anticon';
  src: url('/CrawlService/images/font_148784_r2qo40wrmaolayvi.eot');
  /* IE9*/
  src: url('/CrawlService/images/font_148784_r2qo40wrmaolayvi.woff') format('woff'), /* chrome、firefox、opera、Safari, Android, iOS 4.2+*/ url('/CrawlService/images/font_148784_r2qo40wrmaolayvi.ttf') format('truetype'), /* iOS 4.1- */ url('/CrawlService/images/font_148784_r2qo40wrmaolayvi.svg#iconfont') format('svg');
}
.anticon {
  display: inline-block;
  font-style: normal;
...
ul.head li .page-logo {
  height: 60px;
  opacity: 0.9;
}
ul.head li .page-title {
  position: relative;
  font-size: 25px;
  line-height: 100px;
  color: #4a4a4a;
...
ul.head li .head-circle {
  position: relative;
  display: inline-block;
  height: 100%;
  width: 100px;
}
ul.head li .container {
  position: absolute;
  top: 0;
  left: 0;
  height: 100%;
...
ul.head li .circular-progress::before {
...
.ant-table-row td:nth-child(4) i {
  vertical-align: text-bottom;
  margin-right: 5px;
}
.ant-table-row:hover {
...
.ant-table-expanded-row pre code:nth-child(1) {
...
@media screen and (max-width: 768px) {
  ...
  .ant-layout-header ul.head li {
    height: 70px;
  }
  .ant-layout-header ul.head li h5 {
    margin-top: 10px;
  }
  .ant-layout-header ul.head li .ant-progress {
    position: relative;
    top: -10px;
  }
  .ant-layout-header ul.head li:nth-child(1) {
    width: 40%;
    order: 1;
  }
  .ant-layout-header ul.head li:nth-child(1) img {
    height: 50px;
  }
  .ant-layout-header ul.head li:nth-child(2) {
    width: 60%;
    text-align: left;
    order: 2;
  }
  .ant-layout-header ul.head li:nth-child(n + 3) {
    width: 25%;
  }
  .ant-layout-header ul.head li:nth-child(n + 3) p {
    font-size: 30px;
  }
  .ant-layout-header ul.head li:nth-child(3) {
    order: 3;
  }
  .ant-layout-header ul.head li:nth-child(4) {
    order: 4;
  }
  .ant-layout-header ul.head li:nth-child(5) {
    order: 9;
  }
  .ant-layout-header ul.head li:nth-child(6) {
    order: 10;
  }
  .ant-layout-header ul.head li:nth-child(7) {
    order: 7;
  }
  .ant-layout-header ul.head li:nth-child(8) {
    order: 8;
  }
  .ant-layout-header ul.head li:nth-child(9) {
    order: 5;
  }
  .ant-layout-header ul.head li:nth-child(10) {
    order: 6;
  }
  .file-head ul,
  .ant-table-wrapper {
  ...
  .file-head ul li span span:nth-child(1) {
    display: none;
  }
  .file-head ul li span span:nth-child(2) {
    display: block;
    text-align: center;
  }
  .file-head .anticon {
  ...
  .file-head ul li:nth-child(5),
  .file-head ul li:nth-child(6) {
    display: none;
  }
}
.panel-container {
...
.case-show-panel:hover {
  opacity: 1;
}
.case-show-panel .case-show-radio {
  float: right;
}
.picture-item {
  padding: 2px;
